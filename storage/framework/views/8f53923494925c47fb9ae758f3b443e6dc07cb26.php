        ...
        <div class="orders-wrapper">
            ...
            <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="notif badge badge-danger" id="orders-notif">
                        <?php if(auth()->user()->seller->orders()->exists()): ?>
                            <?php echo e(auth()->user()->seller->orders->where('status', 'confirmed')->count()); ?>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="notif badge badge-danger" id="orders-notif">
                        <?php if(auth()->user()->seller->orders()->exists()): ?>
                            <?php echo e(auth()->user()->seller->orders->where('status', 'On Delivery')->count()); ?>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="notif badge badge-danger" id="orders-notif">
                        <?php if(auth()->user()->seller->orders()->exists()): ?>
                            <?php echo e(auth()->user()->seller->orders->where('status', 'Delivered')->count()); ?>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="notif badge badge-danger" id="orders-notif">
                        <?php if(auth()->user()->seller->orders()->exists()): ?>
                            <?php echo e(auth()->user()->seller->orders->where('status', 'Completed')->count()); ?>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <span class="notif badge badge-danger" id="orders-notif">
                        <?php if(auth()->user()->seller->orders()->exists()): ?>
                            <?php echo e(auth()->user()->seller->orders->where('status', 'cancelled')->count()); ?>
                ...
                <div class="my-order-list">
                    <div class="my-order-item">
                        ...
                        <div class="my-orders-actions">
                            <span class="alert alert-<?php echo e(($order->status == 'pending' ? 'warning' :  ($order->status == 'confirmed' ? 'success' : '' ) )); ?>"> <?php echo e(ucfirst($order->status)); ?></span>

                            <?php if( $order->status == 'pending' && $order->payment_option_id == '2'): ?>
                                <a href="<?php echo e(route('seller.orders.confirmCOD', ['id' => $order->id])); ?>" class="pal-button btn-green" >Confirm COD Request</a>
                            <?php endif; ?>

                            <a class="pal-button btn-orange" href="<?php echo e(route('seller.orders.find', ['id' => $order->id])); ?>">View Order</a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/seller/orders/index.blade.php ENDPATH**/ ?>