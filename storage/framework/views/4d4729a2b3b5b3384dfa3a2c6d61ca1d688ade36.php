        ...
        <div class="grid">
            <div class="grid-wrapper">
                <?php if(count($stalls) > 0): ?>
                    ...
                    <a href="<?php echo e(route('seller.stalls.create', [$stall->id])); ?>" class="grid-item">
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/seller/stalls/select.blade.php ENDPATH**/ ?>