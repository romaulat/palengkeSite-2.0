...
<div class="container">
        <div class="profile">
            <div class="profile-wrapper">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php $__currentLoopData = $buyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $buyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($buyer->user->first_name); ?></td>
                                <td><?php echo e($buyer->user->last_name); ?></td>
                                <td><?php echo e($buyer->user->email); ?></td>
                                <td>
                                    <a href="<?php echo e(route('admin.buyers.recover', $buyer->id)); ?>"> Retrieve </a> | 
                                    <a href="<?php echo e(route('admin.buyers.permanentdelete', $buyer->id)); ?>" title="Permanent Delete">Delete</a>
                                </td>
                            </tr>
                ...
                <?php if( isset($_GET) ): ?>
                <?php echo e($buyers->appends($_GET)->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/admin/users/buyers-trash.blade.php ENDPATH**/ ?>