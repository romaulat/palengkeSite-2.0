        ...
        <div class="profile-wrapper">
            <div class="card basic-info" style="width: 18rem;">
                ...
                <div class="basic-info-body">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('admin.markets.update', [$market->id])); ?>" method="POST" class="form-">
                        <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                                       ...
                                       id="market"
                                       name="market"
                                       placeholder="i.e. Apple" value="<?php echo e($market->market); ?>" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/admin/markets/edit.blade.php ENDPATH**/ ?>