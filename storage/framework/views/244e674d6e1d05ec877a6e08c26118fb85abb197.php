<?php $__env->startSection('content'); ?>
    <div class="profile" style="padding: 60px;">
        <div class="profile-wrapper" >
                ...
                <div class="" style="width: 100%; display: flex">
                    <div class="form-group short    ">
                        ...
                        <select  class="form-control" id="productOption" name="productOption" placeholder="Order By"  >
                            ...
                            <?php for($i=1; $i<=12; $i++): ?>
                                ...
                                ?>
                                <option value="<?php echo e($monthName); ?>" <?php echo e($selected); ?>><?php echo e($monthName); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group short    ">
                        ...
                        <select  class="form-control" id="sort" name="sort" placeholder="Category"  >
                            <option value="desc" <?php echo e((isset($_GET['sort']) && $_GET['sort'] == 'desc' ? 'selected' : '')); ?>>Sales (Highest - Lowest)</option>
                            <option value="asc" <?php echo e((isset($_GET['sort']) && $_GET['sort'] == 'asc' ? 'selected' : '')); ?>>Sales (Lowest - Highest)</option>
                        </select>
                    </div>
            ...
            <a class="pal-button btn-green" href="<?php echo e(route('seller.analytics.product.sales.export')); ?>" id="downloadCSV"><i class="fa fa-download"></i> Download </a>
            <script>
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/seller/analytics/order-by-products.blade.php ENDPATH**/ ?>