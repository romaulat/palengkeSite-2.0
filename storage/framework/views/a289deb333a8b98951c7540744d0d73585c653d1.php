                    ...
                    <table class="table table-bordered">
                        ...
                        <?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.staffs.recover', $staff->id)); ?>"> Retrieve </a> | 
                                    <a href="<?php echo e(route('admin.staffs.permanentdelete', $staff->id)); ?>" title="Permanent Delete">Delete</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/admin/users/staff-trash.blade.php ENDPATH**/ ?>