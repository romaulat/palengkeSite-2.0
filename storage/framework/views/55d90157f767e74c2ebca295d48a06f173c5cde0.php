        ...
        <div class="profile-wrapper" id="buyer-wrapper">
            <div class="card basic-info" id="buyer-info" style="width: 18rem;">
                ...
                <div class="basic-info-body">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('buyer.store')); ?>" method="POST" class="form-" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="age" name="age" placeholder="Age" value="<?php echo e(old('age')); ?>" readonly>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="gender" name="gender" placeholder="Gender" value="<?php echo e(old('gender')); ?>" >
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="contact" name="contact"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" placeholder="Enter your contact number eg 9123456789" value="<?php echo e(old('contact')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="stnumber" name="stnumber" placeholder="Example: 123" value="<?php echo e(old('stnumber')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="stname" name="stname" placeholder="" value="<?php echo e(old('stname')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                                        ...
                                        <option value="<?php echo e(old('city')); ?>">Please select City</option>
                                    </select>
...
if (isset($messageCache)) { $message = $messageCache; }
                                            ...
                                            name="barangay"
                                            placeholder="">
                                        <option value="<?php echo e(old('barangay')); ?>">Please select Barangay</option>
                                    </select>
                                    <?php if ($errors->has('city')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('city'); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" id="zip" name="zip" placeholder="" value="<?php echo e(old('zip')); ?>" readonly>
        ...
        const support = {
            init: function () {
               ...
               // support.initJsonFunction();
                ...
                $('#barangay').val('<?php echo e(old("barangay")); ?>');
            },
            loadCities: function () {
                $.ajax({
                    type:'GET',
                    ...
                    success:function(data) {
                       ...
                       for(var i = 0; i < cities.length; i++){
                        ...
                        var selectedCity = '<?php echo e(old("city")); ?>';
                        if (selectedCity) {
                ...
                trigger.change(function (e) {
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            var selectedBarangay = '<?php echo e(old("barangay")); ?>';
...
<?php echo $__env->make('layouts.buyer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/buyer/create.blade.php ENDPATH**/ ?>