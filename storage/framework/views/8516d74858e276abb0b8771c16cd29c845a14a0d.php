                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="product-item" >
                            ...
                            <div class="product-details">
                                <h4><?php echo e(( $product->custom_title != '' ? $product->custom_title :  $product->product_name)); ?></h4>
                                ...
                                <form action="<?php echo e(route('shop.product.addToCart')); ?>" method="POST">
                                    ...
                                    <button class="add-to-cart btn btn-orange" type="submit" <?php echo e(($product->stock ? '' : 'disabled')); ?>> <span class="fa fa-shopping-cart"></span> Add to Cart</button>
                                </form>
                            </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/shop/category.blade.php ENDPATH**/ ?>