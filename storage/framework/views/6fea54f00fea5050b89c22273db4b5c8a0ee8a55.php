<?php $__env->startSection('content'); ?>
    <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>">Edit</a> |
                                    <a href="#" data-action-delete="Product" data-href="<?php echo e(route('admin.products.delete', $product->id)); ?>">Delete</a>
                                </td>
                                <td>
                                    ...
                                    <?php elseif($product->status == 'pending'): ?>
                                        <a href="<?php echo e(route('admin.products.approve', ['id' => $product->id])); ?>"  class="btn btn-primary"> Approve</a>
                                    <?php endif; ?>
                                </td>
                                <td><a href="<?php echo e(route('admin.pricing.show', $product->id)); ?>"><span class="fa fa-eye"> </span> View Pricing</a></td>
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="info-header-edit"> <i class="fa fa-plus-circle"></i></a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/admin/products/show.blade.php ENDPATH**/ ?>