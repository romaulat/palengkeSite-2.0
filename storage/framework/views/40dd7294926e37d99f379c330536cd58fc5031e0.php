                            ...
                            <div class="add-to-cart-area">
                                <form action="<?php echo e(route('shop.product.addToCart')); ?>" method="POST">
                                    ...
                                    <div class="form-group row" style="margin: 0; align-items: center">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control-plaintext quantity" name="quantity" id="quantity" value="" max="<?php echo e($sellerProduct->stock); ?>">
                                        </div>
                                        <div class="col-sm-5">
                                            <button class="btn btn-orange details-add-to-cart" type="submit" <?php echo e(($sellerProduct->stock ? '' : 'disabled')); ?>>Add to Cart</button>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\palengkesite\resources\views/shop/product/index.blade.php ENDPATH**/ ?>