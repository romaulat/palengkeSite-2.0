        ...
        <?php if(Route::has('login')): ?>
            <div class="nav-section">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('seller')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
                <?php else: ?>
                ...
                <div class="bg-area" style="">
                    <div class="logo-area">
                        <a href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset('images/logo-palengkesite.png')); ?>" alt="Palengkesite">
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\palengkesite\resources\views/layouts/login.blade.php ENDPATH**/ ?>