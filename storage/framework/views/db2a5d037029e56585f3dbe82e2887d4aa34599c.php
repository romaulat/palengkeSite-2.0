                ...
                <div class="sidebar seller ">
                    ...
                    <div class="nav-seller" style="overflow-y: scroll; height: 580px;">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(route('seller.stalls.show')); ?>">
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->seller()->exists()): ?>
                                <?php if(auth()->user()->seller->seller_stalls()->where('status', 'active')->count()  > 0): ?>
                                    <li class="collapsed" data-toggle="collapse" data-target="#products_submenu">
                                        ...
                                        <div class="collapse <?php echo e((request()->segment(2) == 'products') ? 'show' : ''); ?>" id="products_submenu" aria-expanded="false">
                                            <ul>
                                                <li>
                                                    <a href="<?php echo e(route('seller.products.show')); ?>" class="<?php echo e(( request()->routeIs('seller.products.show') ? 'active' : '' )); ?>">
                                                        <span class="icon"><i class="fa fa-store"></i></span>
                                                        <span class="item">List</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('seller.products.trash')); ?>" class="<?php echo e(( request()->routeIs('seller.products.trash') ? 'active' : '' )); ?>">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('seller.orders.show')); ?>">
                                            ...
                                            <span class="notif badge badge-danger" id="orders-notif">
                                                <?php if(auth()->user()->seller->orders()->exists()): ?>
                                                    <?php echo e(auth()->user()->seller->orders->where('status', 'pending')->count()); ?>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('seller.chats')); ?>">
                                            <span class="icon"><i class="fas fa-envelope"></i></span>
                                            <span class="item">Messages</span>
                                            <span class="notif badge badge-danger" id="messages-notif">
                                                <?php if(auth()->user()->seller->messages()->exists()): ?>
                                                    <?php echo e(auth()->user()->seller->messages->where('status', 'unread')->where('sender', 'buyer')->count()); ?>
                                    ...
                                    <li data-toggle="collapse" data-target="#sellers_submenu">
                                        ...
                                        <div class="collapse <?php echo e((request()->segment(3) == 'products') ? 'show' : ''); ?>" id="sellers_submenu" aria-expanded="false">
                                            <ul>
                                                <li>
                                                    <a href="<?php echo e(route('seller.analytics.product.sales')); ?>" class="<?php echo e(( request()->routeIs('seller.analytics.product.sales') ? 'active' : '' )); ?>">
                                                        <span class="icon"><i class="fa fa-store"></i></span>
                                                        <span class="item">Products</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('seller.analytics.product.ratings')); ?>" class="<?php echo e(( request()->routeIs('seller.analytics.product.ratings') ? 'active' : '' )); ?>">
...
<?php /**PATH C:\laragon\www\palengkesite\resources\views/layouts/seller.blade.php ENDPATH**/ ?>