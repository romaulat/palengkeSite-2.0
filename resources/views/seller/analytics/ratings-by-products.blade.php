                ...
                <div class="" style="width: 100%; display: flex">
                    ...
                    <div class="form-group short    ">
                        ...
                        <select  class="form-control" id="sort" name="sort" placeholder="Category"  >
                            <option value="desc" {{ (isset($_GET['sort']) && $_GET['sort'] == 'desc' ? 'selected' : '')  }}>Ratings (Highest - Lowest)</option>
                            <option value="asc" {{ (isset($_GET['sort']) && $_GET['sort'] == 'asc' ? 'selected' : '')  }}>Ratings (Lowest - Highest)</option>
                        </select>
                    </div>
